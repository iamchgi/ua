...
//    String public static dburl="jdbc:mysql://localhost:3306/telega";
    public static String  dbusername="telega";
    public static String  dbpassword="telega%$#@!";
    public static void myselect(){
      String  dburl="jdbc:mysql://localhost:3306/telega";
      String  dbusername="telega";
      String  dbpassword="telega%$#@!";
        try {
