...
public class TelegramBotsApi1 {
     ...
     *
     */
    public TelegramBotsApi1(Class<? extends BotSession> botSessionClass) throws TelegramApiException {
     ...
     */
    public TelegramBotsApi1(Class<? extends BotSession> botSessionClass, Webhook webhook) throws TelegramApiException {
        if (botSessionClass == null) {
            throw new TelegramApiException("Parameter botSessionClass can not be null or empty");
        }
        if (webhook == null) {
